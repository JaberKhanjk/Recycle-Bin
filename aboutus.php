...
<body>
  ...
  background-size: cover; min-height: 100vh;">
            <div style="padding: 20px">
                <a href="home.php"><img style="width:200px;margin-left:auto;margin-right:auto;display:block " src="../Recycle-Bin/logo.png"> </a>
                
                <h1 style="text-align:center;">Recycle Bin</h1>
                <a href="aboutus.php">
                    <h2 style="text-align:center;color:black;padding-top: 20px;">About Us</h2>
                </a>
            </div>
